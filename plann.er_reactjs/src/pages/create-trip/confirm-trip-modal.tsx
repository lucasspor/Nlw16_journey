...
export function ConfirmTripModal({ closeConfirmTripModal, createTrip, setOwnerEmail, setOwnerName, destination}: ConfirmTripModalProps) {
  return (
    <div className='fixed bg-black/60 inset-0 flex items-center justify-center'>
      <div className="w-[580px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
        <div className='space-y-2'>
          ...
          <p className="text-sm text-zinc-400">Para concluir a criação da viagem para <span className='text-zinc-100 font-bold'>{destination}</span> nas datas de <span className='text-zinc-100 font-bold'></span> preencha seus dados abaixo:</p>
        </div>
